...
class ParticipantSummary extends Component<{ username: string }, { prs: GithubUserEvent<PullRequestPayload>[] }> {
    ...
    componentDidMount() {
        this.participantMgr.list(this.props.username).then(prs => this.setState({ prs }));
    }
